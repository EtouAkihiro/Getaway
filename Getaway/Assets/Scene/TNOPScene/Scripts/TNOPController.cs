...
public class TNOPController : MonoBehaviour
{
    ...
    /// <summary>一人でプレイする画面のオブジェクト</summary>
    RectTransform m_SoloSelectObjects;
    /// <summary>複数人でプレイする画面のオブジェクト</summary>
    RectTransform m_PluralPlaySelectObjects;
    ...
    void Start() {
        ...
        // 一人でプレイする画面のオブジェクトを取得
        m_SoloSelectObjects = GameObject.Find("soloSelectObjects").GetComponent<RectTransform>();
        // 複数人でプレイする画面のオブジェクトを取得
        m_PluralPlaySelectObjects = GameObject.Find("PluralPlaySelectObjects").GetComponent<RectTransform>();
    ...
    void Solo() {
        ...
        if(EventSystem.current.currentSelectedGameObject == null && m_SoloSelectObjects.localPosition.x == 0) {
    ...
    void Plural() {
        // 選択されているオブジェクトがなかった場合
        if (EventSystem.current.currentSelectedGameObject == null && m_PluralPlaySelectObjects.localPosition.x == 0) {
